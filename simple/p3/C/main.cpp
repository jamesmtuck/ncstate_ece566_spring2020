...
InputFilename(cl::Positional, cl::Required, cl::desc("<input bitcode>"), cl::init("-"));

static cl::opt<std::string>
OutputFilename(cl::Positional, cl::Required, cl::desc("<output bitcode>"), cl::init("out.bc"));
 ...
 if (DumpSummary)
   {
      ...
      Summarize(wrap(M.get()),"p3",filename);
   }
   {
     legacy::PassManager Passes;
     Passes.add(createDeadCodeEliminationPass());
